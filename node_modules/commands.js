  ...
  if ( shell ) {
    ...
    //
      ...
      //
        ...
        shell.env.context.scheduling.startDate = true;
        emitter.emit( 'schedulePrompt', MCat.startDatePrompt, null );
      }
