  ...
  if ( shell ) {
    ...
    if ( shell.env.context.scheduling ) {
      ...
      if ( command == '.' ) {
        ...
        emitter.emit( 'completedCommand', connectionId );
        library.event.create( connectionId, connection, eventBuffer );
      }
        ...
        var min,max;
        if ( eventBuffer.configurations[basketCount].min )
          min = eventBuffer.configurations[basketCount].min.toString();
        else
          min = MCat.nullSymbol;
        if ( eventBuffer.configurations[basketCount].max )
          max = eventBuffer.configurations[basketCount].max.toString();
        else
          max = MCat.nullSymbol;
        eventBuffer.configurations[basketCount].title = min + 
          MCat.daysSeparator + max + MCat.basketSuffix;
