...
function Env( version, authHandler, finishHandler ) {
  ...
  this.__finishHandler = finishHandler;
  ...
  this.hasConnections = function () {
    ...
    if ( totalConnections === 0 ) {
      console.log( MCat.errorPrefix + ' - ' + MCat.errorNoConnection );
      return false;
    }
    return true;
  };
  ...
  if ( initState.isInvalidEmulator ) {
    self.__finishHandler(null, MCat.nonAdminWarning );
  }
