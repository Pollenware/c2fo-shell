...
function MCat () {
  ...
  this.deletingEventMsg   = 'deleting expired event #';
  ...
  this.failedAwardMsg     = 'failed to retrieve award data';
  this.failedEventMsg     = 'failed to retrieve event details';
  this.failedLockMsg      = 'failed to lock basket';
  this.failedOfferMsg     = 'failed to place offer';
  this.failedOffersMsg    = 'failed to retrieve offer details';
  this.failedPreOfferMsg  = 'failed to retrieve pre-ffers';
  this.failedSignInMsg    = 'could not sign in';
