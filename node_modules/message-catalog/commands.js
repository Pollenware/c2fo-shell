...
function MCat () {
  ...
  this.daysSeparator       = '-';
  this.dotMessage          =  "    Type \".\" to stop adding baskets.";
  ...
  this.logFile             = 'log/c2fo.log';
  this.logClear            = 'log cleared';
  this.logWrite            = 'writing log to';
  this.maxDaysPrompt       = '      Maximum days (enter "L: for "latest possible")';
  ...
  this.successCreate      = 'event created';
