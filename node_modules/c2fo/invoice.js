var MCat  = require( 'message-catalog/c2fo/invoice.js' ).MCat;
...
function Invoice( net, finishHandler, emitter, pageSize ) {
  ...
  self.get = function ( connectionId, connection, query ) {
    ...
    if ( connection ) { 
      ...
      emitter.emit( 'failedC2FOservice', null, MCat.failedNoConnection );
    }
  ...
  self.__marshalQuery = function ( connection, query ) {
    ...
    for ( var token in query ) {
      var pattern = /^([bkamountdevsrOipl_\-]+)([<>=])([A-Za-z0-9_\-\.]+)$/;
